...
public partial class QydhaContext : DbContext
{
    ...
    public virtual DbSet<InfluencercodesCategory> InfluencercodesCategories { get; set; }
    ...
    public virtual DbSet<UserBalootSetting> UserBalootSettings { get; set; }

    public virtual DbSet<UserGeneralSetting> UserGeneralSettings { get; set; }

    public virtual DbSet<UserHandSetting> UserHandSettings { get; set; }

    public virtual DbSet<UserPromoCode> UserPromoCodes { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseNpgsql("User ID=postgres;Password=123Admin;Host=localhost;Port=5432;Database=qydhaDev;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<InfluencercodesCategory>(entity =>
        {
        ...
        modelBuilder.Entity<NotificationsDatum>(entity =>
        {
        ...
        modelBuilder.Entity<NotificationsUsersLink>(entity =>
        {
            ...
            entity.HasOne(d => d.Notification).WithMany(p => p.NotificationsUsersLinks)
                .HasForeignKey(d => d.NotificationId)
                .HasConstraintName("fk_notification_at_notification_link_table");

            entity.HasOne(d => d.User).WithMany(p => p.NotificationsUsersLinks)
                .HasForeignKey(d => d.UserId)
        ...
        modelBuilder.Entity<UserBalootSetting>(entity =>
        {
            ...
            entity.HasOne(d => d.User).WithOne(p => p.UserBalootSetting)
                .HasForeignKey<UserBalootSetting>(d => d.UserId)
                .HasConstraintName("user_baloot_settings_user_id_fkey");
        });

        modelBuilder.Entity<UserGeneralSetting>(entity =>
        {
            ...
            entity.HasOne(d => d.User).WithOne(p => p.UserGeneralSetting)
                .HasForeignKey<UserGeneralSetting>(d => d.UserId)
                .HasConstraintName("user_general_settings_user_id_fkey");
        });

        modelBuilder.Entity<UserHandSetting>(entity =>
        {
            ...
            entity.HasOne(d => d.User).WithOne(p => p.UserHandSetting)
                .HasForeignKey<UserHandSetting>(d => d.UserId)
