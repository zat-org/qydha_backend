...
namespace Qydha.Api.Migrations
{
    ...
    [Migration("20240808191738_AddUniqueConstraintToPurchaseId")]
    partial class AddUniqueConstraintToPurchaseId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Qydha.Domain.Entities.BalootGame", b =>
                {
                    ...
                    b.Property<string>("DeviceData")
                        ...
                        .HasDefaultValueSql("'{\"Environment\":null,\"AppVersion\":null,\"Platform\":null,\"DeviceName\":null,\"DeviceId\":null}'::jsonb");
            ...
            modelBuilder.Entity("Qydha.Domain.Entities.ServiceAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("62dd9f79-a8a1-4031-ba55-c2ddca88b0bb"),
                            Description = "qydha primary service account",
                            Name = "قيدها",
                            Permissions = new[] { 0, 6, 1, 4, 5 }
                        });
                });
            ...
            modelBuilder.Entity("Qydha.Domain.Entities.User", b =>
                {
                    b.OwnsOne("Qydha.Domain.Entities.BalootGameBoard", "BalootGameBoards", b1 =>
                        {
                            ...
                            b1.ToTable("baloot_boards", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("UserId");
                        });

                    b.OwnsMany("Qydha.Domain.Entities.RefreshToken", "RefreshTokens", b1 =>
                        {
                            b1.Property<Guid>("UserId")
                                .HasColumnType("uuid");
                            ...
                            b1.Property<DateTimeOffset>("ExpireAt")
                                .HasColumnType("timestamp with time zone")
                                .HasColumnName("expire_at");
                    ...
                    b.OwnsOne("Qydha.Domain.Entities.UserBalootSettings", "UserBalootSettings", b1 =>
                        {
                            ...
                            b1.HasData(
                                new
                                {
                                    UserId = new Guid("d2705466-4304-4830-b48a-3e44e031927e")
                                });
                        });
                    ...
                    b.OwnsOne("Qydha.Domain.Entities.UserGeneralSettings", "UserGeneralSettings", b1 =>
                        {
                            ...
                            b1.Property<List<string>>("PlayersNames")
                                .IsRequired()
                                .HasColumnType("text[]")
                                .HasColumnName("players_names");

                            b1.Property<List<string>>("TeamsNames")
                                .IsRequired()
                                .HasColumnType("text[]")
