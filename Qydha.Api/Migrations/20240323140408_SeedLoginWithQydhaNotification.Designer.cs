...
namespace Qydha.Api.Migrations
{
    ...
    [Migration("20240323140408_SeedLoginWithQydhaNotification")]
    partial class SeedLoginWithQydhaNotification
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Qydha.Domain.Entities.AdminUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 11, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
